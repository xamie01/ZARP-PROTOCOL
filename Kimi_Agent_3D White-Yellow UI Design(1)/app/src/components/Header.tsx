          ...
          <div className="flex items-center gap-3">
            {isConnected ? (
              ...
              <button
                ...
                className="flex items-center gap-2 bg-black text-white rounded-lg px-4 py-2 text-xs font-medium hover:bg-[#FFD100] hover:text-black transition-all duration-300 disabled:opacity-60"
              >
