  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <div className="max-w-[1200px] mx-auto px-6 pb-20 flex flex-col lg:flex-row gap-12 items-start justify-center">
        ...
        {/* How Decryption Works Column */}
        <div className="w-full lg:flex-1 lg:max-w-[600px] flex flex-col gap-6 text-left mt-0">
          <ScrollReveal>
            ...
            {[
              ...
              <ScrollReveal key={s.title} delay={i * 150}>
                <div className="flex gap-4 items-start">
                  <div className={`w-12 h-12 rounded-full ${s.bg} flex items-center justify-center text-white shrink-0`}>
                    <s.icon className="w-5 h-5" strokeWidth={2} />
                  </div>
                  <div>
                    <h4 className="text-lg font-semibold text-[#1A1D20] dark:text-white">{s.title}</h4>
