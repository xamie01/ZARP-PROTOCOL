...
export interface WrapperPairConfig {
  erc20: { address: string; symbol: string; decimals: number; name?: string };
  erc7984: { address: string; symbol: string; decimals: number; name?: string };
  chainId: number;
}
...
export const SEPOLIA_PAIRS: WrapperPairConfig[] = [
  {
    erc20: { address: "0x9b5Cd13b8eFbB58Dc25A05CF411D8056058aDFfF", symbol: "USDCMock", decimals: 6, name: "USD Coin Mock" },
    erc7984: { address: "0x7c5BF43B851c1dff1a4feE8dB225b87f2C223639", symbol: "cUSDCMock", decimals: 6, name: "Confidential USD Coin Mock" },
    chainId: SEPOLIA_CHAIN_ID,
  },
  {
    erc20: { address: "0xa7dA08FafDC9097Cc0E7D4f113A61e31d7e8e9b0", symbol: "USDTMock", decimals: 6, name: "Tether USD Mock" },
    erc7984: { address: "0x4E7B06D78965594eB5EF5414c357ca21E1554491", symbol: "cUSDTMock", decimals: 6, name: "Confidential Tether USD Mock" },
    chainId: SEPOLIA_CHAIN_ID,
  },
  {
    erc20: { address: "0xff54739b16576FA5402F211D0b938469Ab9A5f3F", symbol: "WETHMock", decimals: 18, name: "Wrapped Ether Mock" },
    erc7984: { address: "0x46208622DA27d91db4f0393733C8BA082ed83158", symbol: "cWETHMock", decimals: 18, name: "Confidential Wrapped Ether Mock" },
    chainId: SEPOLIA_CHAIN_ID,
  },
  {
    erc20: { address: "0xFf021fB13cA64e5354c62c954b949a88cfDEb25E", symbol: "BRONMock", decimals: 18, name: "Bron Mock" },
    erc7984: { address: "0xaa5612FA27c927a0c7961f5AEFEE5ba3A0F9C891", symbol: "cBRONMock", decimals: 18, name: "Confidential Bron Mock" },
    chainId: SEPOLIA_CHAIN_ID,
  },
  {
    erc20: { address: "0x75355a85c6FB9df5f0C80FF54e8747EEe9a0BF57", symbol: "ZAMAMock", decimals: 18, name: "Zama Mock" },
    erc7984: { address: "0xf2D628d2598aF4eAF94CB76a437Ff86CA78FfbFB", symbol: "cZAMAMock", decimals: 18, name: "Confidential Zama Mock" },
    chainId: SEPOLIA_CHAIN_ID,
  },
  {
    erc20: { address: "0x93c931278A2aad1916783F952f94276eA5111442", symbol: "tGBPMock", decimals: 18, name: "Tokenized GBP Mock" },
    erc7984: { address: "0xfCE5c7069c5525eF6c8C2b2E35A745bA20a2F7CC", symbol: "ctGBPMock", decimals: 18, name: "Confidential Tokenized GBP Mock" },
    chainId: SEPOLIA_CHAIN_ID,
  },
  {
    erc20: { address: "0x24377AE4AA0C45ecEe71225007f17c5D423dd940", symbol: "XAUtMock", decimals: 18, name: "Tether Gold Mock" },
    erc7984: { address: "0xe4FcF848739845BC81Dee1d5352cf3844F0a60C7", symbol: "cXAUtMock", decimals: 18, name: "Confidential Tether Gold Mock" },
    chainId: SEPOLIA_CHAIN_ID,
  },
  {
    erc20: { address: "0xf6Ef9ADB61A48E29E36bc873070A46A3D2667ff3", symbol: "tGBP", decimals: 18, name: "Tokenized GBP" },
    erc7984: { address: "0x167DC962808B32CFFFc7e14B5018c0bE06A3A208", symbol: "ctGBP", decimals: 18, name: "Confidential Tokenized GBP" },
    chainId: SEPOLIA_CHAIN_ID,
  },
];
...
export const MAINNET_PAIRS: WrapperPairConfig[] = [
  {
    erc20: { address: "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", symbol: "USDC", decimals: 6, name: "USD Coin" },
    erc7984: { address: "0xe978F22157048E5DB8E5d07971376e86671672B2", symbol: "cUSDC", decimals: 6, name: "Confidential USD Coin" },
    chainId: MAINNET_CHAIN_ID,
  },
  {
    erc20: { address: "0xdAC17F958D2ee523a2206206994597C13D831ec7", symbol: "USDT", decimals: 6, name: "Tether USD" },
    erc7984: { address: "0xAe0207C757Aa2B4019Ad96edD0092ddc63EF0c50", symbol: "cUSDT", decimals: 6, name: "Confidential Tether USD" },
    chainId: MAINNET_CHAIN_ID,
  },
  {
    erc20: { address: "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", symbol: "WETH", decimals: 18, name: "Wrapped Ether" },
    erc7984: { address: "0xda9396b82634Ea99243cE51258B6A5Ae512D4893", symbol: "cWETH", decimals: 18, name: "Confidential Wrapped Ether" },
    chainId: MAINNET_CHAIN_ID,
  },
  {
    erc20: { address: "0xBA2C598E11eD093079cC324FCa5BbbA99F616E83", symbol: "BRON", decimals: 18, name: "Bron" },
    erc7984: { address: "0x85dE671c3bec1aDeD752c3Cea943521181C826bc", symbol: "cBRON", decimals: 18, name: "Confidential Bron" },
    chainId: MAINNET_CHAIN_ID,
  },
  {
    erc20: { address: "0xA12CC123ba206d4031D1c7f6223D1C2Ec249f4f3", symbol: "ZAMA", decimals: 18, name: "Zama" },
    erc7984: { address: "0x80CB147Fd86dC6dEe3Eee7e4Cee33d1397d98071", symbol: "cZAMA", decimals: 18, name: "Confidential Zama" },
    chainId: MAINNET_CHAIN_ID,
  },
  {
    erc20: { address: "0x27f6c8289550fce67f6b50bed1f519966afe5287", symbol: "tGBP", decimals: 18, name: "Tokenized GBP" },
    erc7984: { address: "0xa873750ccBafD5ec7Dd13bfD5237d7129832eDD9", symbol: "ctGBP", decimals: 18, name: "Confidential Tokenized GBP" },
    chainId: MAINNET_CHAIN_ID,
  },
  {
    erc20: { address: "0x68749665FF8D2d112Fa859AA293F07A622782F38", symbol: "XAUt", decimals: 6, name: "Tether Gold" },
    erc7984: { address: "0x73cc9aF9d6BEFdb3c3fAf8a5E8c05Cb95FdaEEf1", symbol: "cXAUt", decimals: 6, name: "Confidential Tether Gold" },
    chainId: MAINNET_CHAIN_ID,
  },
];
