...
`{skill_dir}` is `.claude/skills/fhevm-skill`, `.agents/skills/fhevm-skill`, or `.cursor` depending on the install. Findings cite the anti-patterns.md ID. A non-zero exit blocks delivery.
